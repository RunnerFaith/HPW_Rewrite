...
f(tab, "ru", "#searchspells", "Поисковые заклинания")
...
f(tab, "ru", "#duplicatetree", "дублировать %s дерево")
f(tab, "ru", "#duplicatebindtree", "дублировать дерево")
f(tab, "ru", "#removetree", "Удалить %s дерево")
f(tab, "ru", "#modifybind", "модифицировать бинд")
f(tab, "ru", "#modifykey", "модифицировать Клавиша")
f(tab, "ru", "#removebind", "Удалить бинд")
